...
Textbox backgrounds are set for multiple textboxes (`e27`, `e28`, ..., `e39`) on the display. The background color (`bco`) and text color (`pco`) are configured based on the `fondo` and `fontColor.val` variables, providing a consistent visual theme for text input areas.
...
.. code-block:: javascript
    ...
    {
      //Spanish
      xstr 295,25,260,25,4,fontColor.val,color,1,1,3,"Eventos-3"
    }else if(sys0==1)
    {
      //Italian
      xstr 325,25,200,25,4,fontColor.val,color,1,1,3,"Eventi-3"
    }else if(sys0==2)
    {
      //French
      xstr 325,25,200,25,4,fontColor.val,color,1,1,3,"Evénements-3"
    }else if(sys0==3)
    {
      //English
      xstr 325,25,200,25,4,fontColor.val,color,1,1,3,"Events-3"
    }else if(sys0==4)
    {
      //German
      xstr 325,25,200,25,4,fontColor.val,color,1,1,3,"Veranstaltungen-3"
    }else if(sys0==5)
    {
      //Portuguese
      xstr 325,25,200,25,4,fontColor.val,color,1,1,3,"Eventos-3"
    }
    //Page text end
    //Next button
    ...
    //Textbox background
    e27.bco=fondo
    e27.pco=fontColor.val
    e28.bco=fondo
    e28.pco=fontColor.val
    e29.bco=fondo
    e29.pco=fontColor.val
    e30.bco=fondo
    e30.pco=fontColor.val
    e31.bco=fondo
    e31.pco=fontColor.val
    e32.bco=fondo
    e32.pco=fontColor.val
    e33.bco=fondo
    e33.pco=fontColor.val
    e34.bco=fondo
    e34.pco=fontColor.val
    e35.bco=fondo
    e35.pco=fontColor.val
    e36.bco=fondo
    e36.pco=fontColor.val
    e37.bco=fondo
    e37.pco=fontColor.val
    e38.bco=fondo
    e38.pco=fontColor.val
    e39.bco=fondo
    e39.pco=fontColor.val
