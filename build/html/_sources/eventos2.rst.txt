...
Textbox backgrounds are set for multiple textboxes (`e14`, `e15`, ..., `e26`) on the display. The background color (`bco`) and text color (`pco`) are configured based on the `fondo` and `fontColor.val` variables, providing a consistent visual theme for text input areas.
...
.. code-block:: javascript
    ...
    {
      //Spanish
      xstr 295,25,260,25,4,fontColor.val,color,1,1,3,"Eventos-2"
    }else if(sys0==1)
    {
      //Italian
      xstr 325,25,200,25,4,fontColor.val,color,1,1,3,"Eventi-2"
    }else if(sys0==2)
    {
      //French
      xstr 325,25,200,25,4,fontColor.val,color,1,1,3,"Evénements-2"
    }else if(sys0==3)
    {
      //English
      xstr 325,25,200,25,4,fontColor.val,color,1,1,3,"Events-2"
    }else if(sys0==4)
    {
      //German
      xstr 325,25,200,25,4,fontColor.val,color,1,1,3,"Veranstaltungen-2"
    }else if(sys0==5)
    {
      //Portuguese
      xstr 325,25,200,25,4,fontColor.val,color,1,1,3,"Eventos-2"
    }
    //Page text end
    //Next button
    ...
    //Textbox background
    e14.bco=fondo
    e14.pco=fontColor.val
    e15.bco=fondo
    e15.pco=fontColor.val
    e16.bco=fondo
    e16.pco=fontColor.val
    e17.bco=fondo
    e17.pco=fontColor.val
    e18.bco=fondo
    e18.pco=fontColor.val
    e19.bco=fondo
    e19.pco=fontColor.val
    e20.bco=fondo
    e20.pco=fontColor.val
    e21.bco=fondo
    e21.pco=fontColor.val
    e22.bco=fondo
    e22.pco=fontColor.val
    e23.bco=fondo
    e23.pco=fontColor.val
    e24.bco=fondo
    e24.pco=fontColor.val
    e25.bco=fondo
    e25.pco=fontColor.val
    e26.bco=fondo
    e26.pco=fontColor.val
